  ...
  return (
    <nav className="absolute top-0 left-0 right-0 z-50">
      <div className="max-w-7xl mx-auto flex items-center justify-between px-8 py-6">
        ...
        {/* Nav links */}
        <div className="hidden md:flex items-center gap-8 font-mono text-xs uppercase tracking-wider text-ink">
          <button onClick={() => navigate('/')} className="cursor-pointer hover:opacity-60 transition">
            Home
          </button>
